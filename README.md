...
1. [Асинхронная работа](#Асинхронная-работа)
...
Асинхронная версия содержится в ветке [async](https://github.com/architectv/merchantx-task/tree/async).

> Сервис принимает запрос, сразу возвращает id задания и в отдельной горутине начинает его выполнять.
Клиент может узнать статус задания отдельным запросом.
